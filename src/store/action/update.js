...
export const update = (fName,lName,companyContact,companyName,gst,token) => {
    return dispatch => {
        ...
        axios({
            method: 'put',
            url: 'http://localhost:8080/e-commerce/seller/home/update-profile',
            data:{
                firstName: fName,
                lastName: lName,
...
export const updatePassword = (token,label,password,confirmPassword) => {
    return dispatch => {
        ...
        axios({
            method: 'Put',
            url: `http://localhost:8080/e-commerce/${label}/home/reset-password`,
            params:{
                password: password,
...
export const updateAddress = (id,city,state, country, address, zipcode, label, token, user) => {
    return dispatch => {
        ...
        axios({
            method: 'Put',
            url: `http://localhost:8080/e-commerce/${user}/home/update-address/${id}`,
            data:{
                state: state,
                city: city,
                country: country,
...
export const updateProduct = (token, id, name, description) => {
    return dispatch => {
        ...
        axios({
            method: 'put',
            url: `http://localhost:8080/e-commerce/seller/home/update-product/${id}`,
            data:{
                name: name,
